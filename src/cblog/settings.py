...
def get_ssm_parameters():
    ...
    username_param = ssm.get_parameter(Name="/scott/capstone/username", WithDecryption=True)
    password_param = ssm.get_parameter(Name="/scott/capstone/password", WithDecryption=True)
...
DATABASES = {
    'default': {
        ...
        'HOST': 'capstone.c5ggk2gk6wu6.us-east-1.rds.amazonaws.com',
        'PORT': '3306',
    }
}
...
AWS_STORAGE_BUCKET_NAME = 'awscapstones-scott-blog' # please enter your s3 bucket name
